...
const ActivityLogs = () => {
  ...
  const convertToCSV = (data) => {
    const headers = ['ID', 'Timestamp', 'User ID', 'User Name', 'Role', 'Action', 'Description', 'IP Address', 'User Agent', 'Session ID'];
    ...
    <div className="p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        ...
        <div className="bg-white p-4 rounded-lg shadow-sm">
          ...
          <p className="text-2xl font-bold text-purple-600">{pagination.currentPage} / {pagination.totalPages}</p>
        </div>
      </div>
              ...
              {logs.map((log) => (
                <tr key={log.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span className={`px-2 py-1 text-xs font-semibold rounded-full ${getRoleColor(log.user_role)}`}>
                      {log.user_role}
                    </span>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
            ...
            <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
              ...
              <div>
                <nav className="relative z-0 inline-flex rounded-md shadow-sm -space-x-px">
                  ...
                  {[...Array(Math.min(10, pagination.totalPages))].map((_, index) => {
          ...
          <div className="bg-white rounded-lg shadow-xl p-6 w-full max-w-md">
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-500 mb-4">
                ...
                Make sure to export logs for backup before proceeding.
              </p>
              <div className="mb-4">
